        ...
        <div className="container-xl">
                  ...
                  <div>
                    ...
                    <div className="mt-2 flex flex-wrap gap-3">
                      <span className="flex items-center gap-1.5" style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: '#757575' }}>
                        <MapPin size={12} style={{ color: '#F57C00' }} /> {role.location}
                      </span>
                      <span className="flex items-center gap-1.5" style={{ fontFamily: 'var(--font-body)', fontSize: '0.78rem', color: '#757575' }}>
                        <Briefcase size={12} style={{ color: '#F57C00' }} /> {role.dept}
                      </span>
                      <span className="px-2 py-0.5 text-[0.6rem] font-bold tracking-widest uppercase"
                        style={{ background: '#FFF3E0', color: '#E65100', fontFamily: 'var(--font-heading)' }}>
                        {role.type}
                      </span>
                    </div>
                  </div>
          ...
          <AnimateIn delay={0.2}>
            <p className="mt-8 text-sm" style={{ color: '#BDBDBD', fontFamily: 'var(--font-body)' }}>
              Don't see a suitable role? <Link href="/contact" style={{ color: '#F57C00' }}>Send us your CV</Link> — we're always looking for exceptional talent.
            </p>
          </AnimateIn>
        </div>
      </section>
        ...
        <div className="relative z-10 container-xl text-center">
          <AnimateIn>
            ...
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 800, fontSize: 'clamp(1.8rem,3.5vw,3rem)', color: '#FFFFFF', lineHeight: 1.1 }}>
              Ready to Make an <span style={{ background: 'linear-gradient(135deg,#E65100,#FF9800)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Impact?</span>
            </h2>
